...
},
{
  ...
  component: ComponentCreator('/blog/hello-world','526'),
  exact: true,
},
{
  path: '/blog/hola',
  component: ComponentCreator('/blog/hola','b7b'),
  exact: true,
},
{
  path: '/blog/tags',
  component: ComponentCreator('/blog/tags','873'),
  exact: true,
},
{
  path: '/blog/tags/docusaurus',
  component: ComponentCreator('/blog/tags/docusaurus','a92'),
  exact: true,
},
{
  path: '/blog/tags/facebook',
  component: ComponentCreator('/blog/tags/facebook','a5c'),
  exact: true,
},
{
  path: '/blog/tags/hello',
  component: ComponentCreator('/blog/tags/hello','dbc'),
  exact: true,
},
{
  path: '/blog/tags/hola',
...
{
  path: '/blog/welcome',
  component: ComponentCreator('/blog/welcome','fdc'),
  exact: true,
},
{
  path: '/markdown-page',
